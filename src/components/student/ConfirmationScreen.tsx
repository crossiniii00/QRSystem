...
export const ConfirmationScreen: React.FC<ConfirmationScreenProps> = ({
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6">
      <div className="bg-[#EBE3D5] border-2 border-[#D8CEBE] shadow-xs text-center p-6 sm:p-10">
        {/* Top Gold Accent Stripe */}
        <div className="w-16 h-1.5 bg-[#D97706] mx-auto mb-6" />

        <div className="w-12 h-12 bg-[#FAF4EA] text-[#B45309] border border-[#E8D4A2] flex items-center justify-center mx-auto mb-4">
          <CheckSquare className="w-6 h-6 text-[#D97706]" />
        </div>

        <h1 className="text-xl sm:text-2xl font-black text-[#261F18] tracking-tight uppercase">
        ...
        <div className="mt-6 p-5 bg-[#FAF6EE] border-2 border-[#E5D7BE] max-w-md mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mt-2">
            <span className="text-2xl sm:text-3xl font-mono font-black text-[#261F18] tracking-wider select-all">
              {result.referenceNumber}
            </span>
            <button
              onClick={copyReference}
              className="h-9 px-3 bg-[#EBE3D5] border border-[#D8CEBE] text-[#4A3B2C] hover:bg-[#F5EFE6] hover:border-[#B8A183] text-xs font-semibold flex items-center gap-1.5 transition-colors"
          ...
          <p className="text-[11px] text-[#7A6A59] mt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 max-w-xl mx-auto text-left">
          {/* QR Code Box */}
          <div className="p-4 border border-[#D8CEBE] bg-[#FBF9F5] flex flex-col items-center text-center">
            ...
            {qrDataUrl ? (
              <img
                ...
                className="w-36 h-36 border border-[#D8CEBE] p-1 bg-[#EBE3D5]"
              />
            ) : (
              <div className="w-36 h-36 bg-[#EBE3D5] animate-pulse" />
            )}
            <p className="text-[11px] text-[#7A6A59] mt-2 leading-tight">
              Scan with phone camera to instantly access and bookmark your application on mobile.
            </p>
          </div>

          {/* Direct Link Box */}
          <div className="p-4 border border-[#D8CEBE] bg-[#FBF9F5] flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-1.5 text-xs font-bold text-[#382B20] uppercase tracking-wider mb-2">
            ...
            <div className="mt-4 pt-3 border-t border-[#E5D7BE]">
              <button
                ...
                className="w-full py-2 px-3 bg-[#EBE3D5] border border-[#D8CEBE] text-xs font-bold text-[#382B20] hover:bg-[#FAF4EA] hover:border-[#D97706] flex items-center justify-center gap-2 transition-colors uppercase tracking-wider"
              >
                {copiedLink ? (
                  <>
        ...
        <div className="mt-8">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#382B20] text-[#FFFBEB] font-bold text-xs uppercase tracking-wider hover:bg-[#231A12] border border-[#F59E0B] shadow-xs transition-all cursor-pointer"
          >
